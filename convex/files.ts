...
export const getFiles = query({
    ...
    handler: async (ctx, args) => {
        ...
        if (project.ownerId !== identity.subject) throw new Error('Unauthorized acesss to this project');
...
export const getFolderContents = query({
    ...
    handler: async (ctx, args) => {
        ...
        // sort: folders first, then files, alphabetically withing each group
...
export const createFolder = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        if (existing) throw new Error('Folder with this name already exists');
...
export const renameFile = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        const existing = siblings.find((sibling) => sibling.name === args.newName && sibling.type === file.type && sibling._id !== file._id);
